/* Medium Level Shapes Generator JS (in progress!)
 ******************************************************************
...
function generateMediumShapes() {
	...
	switch (0) {
		case 0: // right triangles + square
			// figure1
			square( fig1, 0, 0, 80, 80, color[c2]);
			...
			triangle(fig4, 0, 0, 80, 0, 0, 80, color[c1]);
			arc( fig3, 40, 40, 40, 0.75 * Math.PI, 1.75 * Math.PI, color[c2 + c2]);
			arc( fig4, 40, 40, 40, 1.75 * Math.PI, 0.75 * Math.PI, color[c1 + c2]);
			break;
