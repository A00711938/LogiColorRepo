...
document.getElementById('tr').addEventListener("onclick", trueFun, false);
document.getElementById('fal').addEventListener("onclick", falseFun, false);

function trueFun() {
	if (colorComb(op, c1, c2, c3)){
		if(numberComb(op, nb1, nb2, sum)) {
			score++;
